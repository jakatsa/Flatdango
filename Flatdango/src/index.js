    ...
    .then((data) => {
      data.forEach((films) => {
        ...
        li.addEventListener("click", (e) => {
          ...
          let tickets = document.getElementById("ticket-Holder");
...
function Ticket() {
  ...
  ticketButton.addEventListener("click", function () {
    ...
    if (listNumber > 0) {
      ...
      document.querySelector("button#buy-ticket").textContent = "Sold Out";
